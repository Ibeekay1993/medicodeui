      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto overflow-x-hidden rounded-2xl border-none p-0">
        ...
        <div className="p-5 space-y-4">
          ...
          <Button
            ...
            className="w-full h-11 rounded-xl bg-slate-800 hover:bg-slate-900 text-xs font-black uppercase tracking-widest text-white shadow-lg shadow-slate-900/10 transition-all"
          >
