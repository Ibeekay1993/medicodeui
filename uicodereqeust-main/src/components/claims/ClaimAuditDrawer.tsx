                    ...
                    <div className="grid gap-2">
                      {hasClinical && (
                        <div className="rounded-xl border border-slate-100 bg-white p-3">
                          <p className="text-xs font-semibold text-slate-600 mb-2">Clinical Note</p>
                          <p className="whitespace-pre-line text-xs font-medium leading-relaxed text-slate-700">{noteSections.clinical}</p>
                        </div>
                      )}
                      {hasAudit && (
