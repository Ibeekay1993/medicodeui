...
function RootRedirect() {
  ...
  if (role === "nurse") return <Navigate to="/backoffice/nurse" replace />;
        ...
        <AuthProvider>
          ...
          <ChunkErrorBoundary>
            <Suspense fallback={<PageLoader />}>
              ...
              <Route path="/backoffice/nurse" element={<ProtectedRoute allowedRoles={["nurse"]} loginPath="/login" fallbackPath="/unauthorized"><DashboardLayout /></ProtectedRoute>}>
                <Route index element={<DashboardHome />} />
                <Route path="requests" element={<RequestsPage />} />
                <Route path="messages" element={<SupportMessagesPage />} />
                <Route path="whatsapp" element={<WhatsAppPage />} />
