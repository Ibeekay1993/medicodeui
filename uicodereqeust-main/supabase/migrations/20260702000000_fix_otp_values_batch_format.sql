-- supabase/migrations/20260702000000_fix_otp_values_batch_format.sql
...
BEGIN
  ...
  SELECT
    ...
    CASE 
      ...
      THEN MAX(CASE WHEN o.otp_type = 'ARRIVAL' THEN o.otp_value END)
      
      WHEN MAX(CASE WHEN o.otp_type = 'ARRIVAL' THEN o.otp_value END) IS NOT NULL
      THEN MAX(CASE WHEN o.otp_type = 'ARRIVAL' THEN o.otp_value END)
      
      WHEN MAX(CASE WHEN o.otp_type = 'TREATMENT' THEN o.otp_value END) IS NOT NULL
      THEN MAX(CASE WHEN o.otp_type = 'TREATMENT' THEN o.otp_value END)
      
      ELSE MAX(o.otp_value)
    END as otp_value,
